...
<div class="modal" style="z-index: 2000;" id="personalInformationModal" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form class="needs-validation" id="personal-form" novalidate method="POST">
                <div class="modal-body">
                    <div class="container my-3">
                ...
                <div class="modal-footer">
                   <button type="button" onclick="backToStudentDetail()" class="btn btn-secondary">
                    ...
                    <button type="button" class="btn btn-primary" id="personal-info-btn"><span>Submit </span></button>
                </div>
            </form>
        </div>
    </div>
