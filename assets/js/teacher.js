...
(() => {
    ...
    function validatePersonalForm() {
        if (personalform.checkValidity()) {
            ...
            // Combine general and personal data
            fullFormData = { ...generalFormData, ...personalFormData };
...
function editTeacherById(tid) {
    ...
    fetch('../assets/fetchTeacherInfo.php', {
        ...
        .then(data => {
            ...
            // Transfer guardian fields to personal form if they exist in your HTML
            if (data['guardian']) document.getElementById("guardian").value = data['guardian'];
            if (data['gphone']) document.getElementById("gphone").value = data['gphone'];
            if (data['gaddress']) document.getElementById("gaddress").value = data['gaddress'];
            if (data['gcity']) document.getElementById("gcity").value = data['gcity'];
            if (data['gzip']) document.getElementById("gzip").value = data['gzip'];
            if (data['relation']) document.getElementById("relation").value = data['relation'];
        })
